#ifndef ON_OFF_HELPER_NIX_VECTOR_H
#define ON_OFF_HELPER_NIX_VECTOR_H
 ...
 * on a set of nodes.
 */
class OnOffHelperNixVector
{
  public:
    std::string m_CustomParentVector1;
    std::string m_CustomParentVector2;
    /**
     * Create an OnOffHelperNixVector to make it easier to work with OnOffApplications
     *
     ...
     *        to.
     */
    OnOffHelperNixVector(std::string protocol, Address address);
...
#endif /* ON_OFF_HELPER_NIX_VECTOR_H */
