#ifndef ONOFF_APPLICATION_NIX_VECTOR_H
#define NOFF_APPLICATION_NIX_VECTOR_H
 ...
 * \defgroup onoffnixVector OnOffApplicationNixVector
 *
 ...
 */
class OnOffApplicationNixVector : public Application
{
  ...
  public:
    ...
    OnOffApplicationNixVector();

    ~OnOffApplicationNixVector() override;
    ...
    //void PopulateCacheTable(Ptr<ns3::Node>, Ptr<ns3::Node>, std::string CustomParentVector);
  ...
  public:
    ...
    std::string m_CustomParentVectorStD;
    ...
    //std::vector<std::tuple<Ptr<ns3::Node>, Ptr<ns3::Node>, std::vector<Ptr<Node>>>> GetParentCache();
...
#endif /* ONOFF_APPLICATION_NIX_VECTOR_H */
