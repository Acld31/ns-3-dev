                                                 ...
                                                 T>
{
  ...
  public:
    ...
    std::vector<std::tuple<Ptr<ns3::Node>, Ptr<ns3::Node>, std::vector<Ptr<Node>>>> m_ParentCache;

    void SetCacheTableParentvector(Ptr<Node> source, Ptr<Node> dest, std::vector<Ptr<Node>>  parentvector);

    bool isVectorInList(const std::vector<std::tuple<Ptr<ns3::Node>, Ptr<ns3::Node>, std::vector<Ptr<Node>>>> ParentCache, const std::tuple<Ptr<ns3::Node>, Ptr<ns3::Node>, std::vector<Ptr<Node>>> newItem) ;
    
    bool Custo_BFS(uint32_t numberOfNodes,
             Ptr<Node> source,
             Ptr<Node> dest,
